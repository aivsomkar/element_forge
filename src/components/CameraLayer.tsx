...
const GESTURES: [string, string][] = [
  ['🤲 spread', 'Both open hands — pull apart to peel the world into an atom'],
  ['👐 together', 'Both open hands — bring together to collapse it small'],
  ['🤏 pinch', 'Pinch one hand — grab the element and move it around'],
  ['👋→📷', 'While holding: move your hand toward the camera to pull it closer'],
  ['🔄 two-hand twist', 'Both pinched hands — rotate the element'],
  ['👋 swipe', 'Flick one open hand — spin it'],
